...
$ctable 	= "labels";
$ctable1 	= "Label";
$main_page 	= "Label"; //for sidebar active menu
...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_labels.php?show=" + numRecords + "&searchName=" + searchName;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-labels/delete/'+id+'/';
		}
	}
